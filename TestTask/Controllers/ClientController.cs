...
namespace BankApp.Controllers
{
    public class ClientController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            ViewBag.INNSortParam = sortOrder == "INN" ? "INN_desc" : "INN";
            ...
            switch (sortOrder)
            {
                case "name_desc":
                    ...
                    break;
                case "INN":
                    clients = clients.OrderBy(s => s.INN);
                    break;
                case "INN_desc":
                    clients = clients.OrderByDescending(s => s.INN);
                    break;
                case "Date":
                    clients = clients.OrderBy(s => s.DateOfRegister);
                    break;
                case "date_desc":
                    clients = clients.OrderByDescending(s => s.DateOfRegister);
                    break;
                default:
        ...
        public ActionResult Create([Bind(Include = "FirstName,LastName,INN,DateOfRegister,clientType")] Client client)
        {
            try
            {
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                Client student = db.Clients.Find(id);
